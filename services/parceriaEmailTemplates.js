...
// Templates dos e-mails do fluxo de solicitação de parceria, extraídos do
...
/**
 * Versão texto do e-mail enviado à equipe de análise.
 */
function buildParceriaTextEmail(d) {
  const {
    approvalUrl, baseUrl, cidadeEstacionamento, cnpj, descricao, email,
    enderecoEstacionamento, googleMapsUrl, horarioAbertura, horarioFechamento,
    latitude, logoUrl, longitude, nome, nomeEstacionamento, numeroVagas,
    precoDia, precoHora, rejectionUrl, ufEstacionamento
  } = d;
  return `Nova Solicitação de Parceria: ${nomeEstacionamento}
...
/**
 * Versão HTML (rica) do e-mail enviado à equipe de análise.
 */
function buildParceriaHtmlEmail(d) {
  const {
    approvalUrl, baseUrl, cidadeEstacionamento, cnpj, descricao, email,
    enderecoEstacionamento, googleMapsUrl, horarioAbertura, horarioFechamento,
    latitude, logoUrl, longitude, nome, nomeEstacionamento, numeroVagas,
...
/**
 * HTML do e-mail de confirmação enviado ao solicitante.
 */
function buildParceriaConfirmationHtml(d) {
  const {
    approvalUrl, baseUrl, cidadeEstacionamento, cnpj, descricao, email,
    enderecoEstacionamento, googleMapsUrl, horarioAbertura, horarioFechamento,
    latitude, logoUrl, longitude, nome, nomeEstacionamento, numeroVagas,
