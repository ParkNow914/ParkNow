      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-header">
            ...
            <div class="header-badge">Confirmação de Solicitação</div>
            <h1 class="header-title">Solicitação Recebida!</h1>
            <p class="header-subtitle">Agradecemos por escolher o ParkNow. Sua solicitação está em análise.</p>
          ...
          <div class="email-body">
            <div class="welcome-section">
              ...
              <p class="welcome-text">
                Recebemos sua solicitação de parceria para o estacionamento 
                <strong>${nomeEstacionamento}</strong> e já estamos analisando as informações.
              </p>
            </div>
            ...
            <div class="highlight-box">
              <h3 class="highlight-title">
                <i class="fas fa-clock"></i> Análise em Andamento
              </h3>
              <p class="highlight-text">
                Nossa equipe está analisando suas informações e entrará em contato em até 
                <strong>48 horas úteis</strong> com uma resposta sobre a aprovação do seu cadastro.
              </p>
            </div>
            
            <!-- Próximos Passos -->
            <h3 style="color: #1e293b; font-size: 18px; margin: 30px 0 15px; font-weight: 600;">
            ...
            <div class="steps-container">
              ...
              <div class="step">
                ...
                <div class="step-content">
                  ...
                  <p>Nossa equipe está verificando todas as informações fornecidas para garantir que atendem aos nossos critérios de parceria.</p>
                </div>
              </div>
              ...
              <div class="step">
                ...
                <div class="step-content">
                  ...
                  <p>Estamos verificando a documentação para garantir a segurança e conformidade com as regulamentações.</p>
                </div>
              </div>
              ...
              <div class="step">
                ...
                <div class="step-content">
                  ...
                  <p>Você receberá um e-mail com a resposta sobre a aprovação do seu cadastro em até 48 horas úteis.</p>
                </div>
              </div>
            </div>
            
            <!-- Dados da Solicitação -->
            <div style="background: #f8fafc; border-radius: 10px; padding: 20px; margin: 30px 0; border: 1px solid #e2e8f0;">
              <h3 style="color: #1e293b; font-size: 16px; margin-bottom: 15px; font-weight: 600; display: flex; align-items: center;">
                <i class="fas fa-info-circle" style="color: #3b82f6; margin-right: 10px;"></i>
                Dados da Sua Solicitação
              </h3>
              
              <div style="display: flex; margin-bottom: 8px;">
                <div style="width: 140px; color: #64748b; font-size: 14px;">Nº da Solicitação:</div>
                <div style="font-weight: 500; color: #1e293b;">#${Date.now().toString().slice(-8)}</div>
              </div>
              
              <div style="display: flex; margin-bottom: 8px;">
                <div style="width: 140px; color: #64748b; font-size: 14px;">Data de Envio:</div>
                <div style="font-weight: 500; color: #1e293b;">${new Date().toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })}</div>
              </div>
              
              <div style="display: flex; margin-bottom: 8px;">
                <div style="width: 140px; color: #64748b; font-size: 14px;">Status:</div>
                <div style="font-weight: 600; color: #f59e0b;">Em Análise</div>
              </div>
            </div>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <p style="margin-bottom: 15px; color: #475569; font-size: 14px;">
                Acompanhe o status da sua solicitação a qualquer momento através do nosso site.
              </p>
              <a href="${baseUrl}/minha-conta/solicitacoes" class="cta-button" style="color: white; text-decoration: none;">
                Acompanhar Solicitação
              </a>
            </div>
            
            <!-- Aviso de Segurança -->
            <div style="background: #fef2f2; border-left: 4px solid #ef4444; padding: 15px; border-radius: 6px; margin: 25px 0 0;">
              <p style="color: #991b1b; font-size: 13px; line-height: 1.5; margin: 0; display: flex; align-items: flex-start;">
                <i class="fas fa-shield-alt" style="margin-right: 10px; margin-top: 2px;"></i>
                <span>Por questões de segurança, nunca compartilhe suas credenciais de acesso. A equipe do ParkNow nunca solicitará sua senha por e-mail ou telefone.</span>
              </p>
            </div>
          </div>
          ...
          <div class="email-footer">
            ...
            <p style="margin: 15px 0 20px; color: #64748b; font-size: 13px; line-height: 1.6;">
              Este é um e-mail automático, por favor não responda diretamente a esta mensagem.
            </p>
            
            <div class="social-links" style="margin: 20px 0;">
              <p style="margin: 0 0 10px; color: #64748b; font-size: 14px;">Siga-nos nas redes sociais:</p>
              <div style="display: flex; justify-content: center; gap: 15px;">
                <a href="https://facebook.com/parknow" target="_blank" title="Facebook" style="color: #3b5998; text-decoration: none; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                  <i class="fab fa-facebook-f" aria-hidden="true" style="font-size: 18px; width: 36px; height: 36px; line-height: 36px; text-align: center; background: #f1f5f9; border-radius: 50%;"></i>
                  <span class="sr-only">Facebook</span>
                </a>
                <a href="https://instagram.com/parknow" target="_blank" title="Instagram" style="color: #e1306c; text-decoration: none; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                  <i class="fab fa-instagram" aria-hidden="true" style="font-size: 18px; width: 36px; height: 36px; line-height: 36px; text-align: center; background: #f1f5f9; border-radius: 50%;"></i>
                  <span class="sr-only">Instagram</span>
                </a>
                <a href="https://linkedin.com/company/parknow" target="_blank" title="LinkedIn" style="color: #0077b5; text-decoration: none; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                  <i class="fab fa-linkedin-in" aria-hidden="true" style="font-size: 18px; width: 36px; height: 36px; line-height: 36px; text-align: center; background: #f1f5f9; border-radius: 50%;"></i>
                  <span class="sr-only">LinkedIn</span>
                </a>
                <a href="https://wa.me/5511999999999" target="_blank" title="WhatsApp" style="color: #25d366; text-decoration: none; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                  <i class="fab fa-whatsapp" aria-hidden="true" style="font-size: 18px; width: 36px; height: 36px; line-height: 36px; text-align: center; background: #f1f5f9; border-radius: 50%;"></i>
            ...
            <div class="footer-links">
              <a href="${baseUrl}/termos" target="_blank">Termos de Uso</a>
              <a href="${baseUrl}/privacidade" target="_blank">Política de Privacidade</a>
              <a href="${baseUrl}/ajuda" target="_blank">Central de Ajuda</a>
              <a href="${baseUrl}/contato" target="_blank">Contato</a>
            </div>
            ...
            <div style="margin: 25px 0 15px; padding: 15px; background: #f8fafc; border-radius: 8px; border-left: 4px solid #3b82f6;">
              <p style="margin: 0 0 10px; font-size: 12px; color: #64748b; line-height: 1.5;">
                <strong>Dúvidas ou suporte?</strong> Nossa equipe está pronta para ajudar!
              </p>
              <p style="margin: 0; font-size: 11px; color: #94a3b8; line-height: 1.5;">
                Email: <a href="mailto:suporte@parknow.com.br" style="color: #3b82f6; text-decoration: none;">suporte@parknow.com.br</a><br>
                Telefone: <a href="tel:+5511999999999" style="color: #3b82f6; text-decoration: none;">(11) 99999-9999</a>
              </p>
            </div>
            
            <p style="margin: 15px 0 0; font-size: 11px; color: #94a3b8; line-height: 1.5; border-top: 1px solid #e2e8f0; padding-top: 15px;">
              <strong>Aviso de segurança:</strong> Se você não reconhece esta atividade, por favor entre em contato conosco imediatamente em 
              <a href="mailto:seguranca@parknow.com.br" style="color: #ef4444; text-decoration: none; font-weight: 500;">seguranca@parknow.com.br</a>
            </p>
          </div>
        </div>
      </body>
